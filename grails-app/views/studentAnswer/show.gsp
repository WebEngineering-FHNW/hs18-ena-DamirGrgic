...
<html>
    ...
    <body>
        ...
        <div id="show-studentAnswer" class="content scaffold-show" role="main">
            ...
            <f:display bean="studentAnswer" />
            <g:form resource="${this.studentAnswer}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.studentAnswer}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
